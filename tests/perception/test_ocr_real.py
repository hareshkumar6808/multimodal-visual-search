...
def tesseract_engine() -> TesseractOCREngine:
    return TesseractOCREngine(executable_path=TESSERACT_EXE)
...
def test_real_tesseract_blank_image_yields_empty_result(tesseract_engine: TesseractOCREngine) -> None:
